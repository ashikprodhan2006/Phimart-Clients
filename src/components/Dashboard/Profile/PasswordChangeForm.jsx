...
const PasswordChangeForm = ({ register, errors, watch, isEditing }) => {
    ...
    return (
        <div className="mt-4">
            <button type="button" className="btn btn-link p-0 justify-start text-primary font-semibold h-auto min-h-0" onClick={() => setIsPasswordSectionOpen(!isPasswordSectionOpen)}>Change Password</button>
